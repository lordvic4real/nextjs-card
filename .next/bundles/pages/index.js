...
// module
exports.push([module.i, "html,\nbody {\n  margin: 0;\n  padding: 0;\n  font-family: sans-serif;\n  text-align: center;\n  background: linear-gradient(rgba(0, 0, 110, 0.25), rgba(220, 0, 110, 0.25)),\n    url(\"/static/background.jpg\") no-repeat center center fixed;\n  background-size: cover;\n}\n\n.Grid {\n  margin: 5%;\n  display: flex;\n  flex-flow: row;\n  flex-wrap: wrap;\n}\n\n.static-logo {\n  height: 150px;\n  position: fixed;\n  margin-left: auto;\n  margin-right: auto;\n  top: 20px;\n  left: 0;\n  right: 0;\n  z-index: 99;\n}\n\n.App-header {\n  height: 150px;\n  padding: 20px;\n  color: white;\n}\n", "", {"version":3,"sources":["C:/hello-next/pages/index.css"],"names":[],"mappings":"AAAA;;EAEE,UAAU;EACV,WAAW;EACX,wBAAwB;EACxB,mBAAmB;EACnB;gEAC8D;EAC9D,uBAAuB;CACxB;;AAED;EACE,WAAW;EACX,cAAc;EACd,eAAe;EACf,gBAAgB;CACjB;;AAED;EACE,cAAc;EACd,gBAAgB;EAChB,kBAAkB;EAClB,mBAAmB;EACnB,UAAU;EACV,QAAQ;EACR,SAAS;EACT,YAAY;CACb;;AAED;EACE,cAAc;EACd,cAAc;EACd,aAAa;CACd","file":"index.css","sourcesContent":["html,\nbody {\n  margin: 0;\n  padding: 0;\n  font-family: sans-serif;\n  text-align: center;\n  background: linear-gradient(rgba(0, 0, 110, 0.25), rgba(220, 0, 110, 0.25)),\n    url(\"/static/background.jpg\") no-repeat center center fixed;\n  background-size: cover;\n}\n\n.Grid {\n  margin: 5%;\n  display: flex;\n  flex-flow: row;\n  flex-wrap: wrap;\n}\n\n.static-logo {\n  height: 150px;\n  position: fixed;\n  margin-left: auto;\n  margin-right: auto;\n  top: 20px;\n  left: 0;\n  right: 0;\n  z-index: 99;\n}\n\n.App-header {\n  height: 150px;\n  padding: 20px;\n  color: white;\n}\n"],"sourceRoot":""}]);
...
var _jsxFileName = 'C:\\hello-next\\pages\\index.js';
...
(function () {
    ...
    reactHotLoader.register(Index, 'Index', 'C:/hello-next/pages/index.js');
    reactHotLoader.register(mapDispatchToProps, 'mapDispatchToProps', 'C:/hello-next/pages/index.js');
    reactHotLoader.register(mapStateToProps, 'mapStateToProps', 'C:/hello-next/pages/index.js');
    reactHotLoader.register(_default, 'default', 'C:/hello-next/pages/index.js');
    leaveModule(module);
})();
...
(function () {
    ...
    reactHotLoader.register(startState, 'startState', 'C:/hello-next/store.js');
    reactHotLoader.register(initialCards, 'initialCards', 'C:/hello-next/store.js');
    reactHotLoader.register(addItem, 'addItem', 'C:/hello-next/store.js');
    reactHotLoader.register(reducer, 'reducer', 'C:/hello-next/store.js');
    reactHotLoader.register(initStore, 'initStore', 'C:/hello-next/store.js');
    leaveModule(module);
})();
